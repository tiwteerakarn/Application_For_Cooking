...
public class FilterFoodAdapter extends RecyclerView.Adapter<FilterFoodAdapter.HolderFilterFood> implements Filterable {
    ...
    public FilterFoodAdapter(Context context, ArrayList<Foodmenu> foodmenu5) {
    ...
    public void onBindViewHolder(@NonNull HolderFilterFood holder, int position) {
       ...
       holder.ratingBar.setRating(foodmenu5.get(position).getRating().floatValue());
        ...
        mVip.child(mAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                mfav.child(foodmenu5.get(position).getDocumentId()).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        foodmenu_user.child(foodmenu5.get(position).getUsername()).child(foodmenu5.get(position).getDocumentId()).removeValue();
                                    }
