...
public class User_like_list_Activity extends AppCompatActivity {
    TextView txt_title;
    EditText et_searchfood;
    private List<String> list_id;
    private RecyclerView recyclerView;
    private FilterFoodAdapter userLikeListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_like_list_);
    ...
    private void getAllList(List<String> list_id) {
        ...
        foodRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    userLikeListAdapter = new FilterFoodAdapter(User_like_list_Activity.this,ff);
                    recyclerView.setAdapter(userLikeListAdapter);
                    userLikeListAdapter.notifyDataSetChanged();

                    userLikeListAdapter.setOnItemClickListener(new FoodmenuAdapter.OnItemClickListener() {
                        @Override
                        public void onItemClick(int position) {
                            Intent intent = new Intent(User_like_list_Activity.this, FoodDetailActivity.class);
